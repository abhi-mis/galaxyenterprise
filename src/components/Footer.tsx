import { Mail, Phone, MapPin, Facebook, Twitter, Linkedin, Anchor } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/certifications" className="text-gray-400 hover:text-blue-400">
                  Certifications
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center space-x-2">
                ...
                <span className="text-gray-400">123 Harbor Street, Port City</span>
              </li>
              <li className="flex items-center space-x-2">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span className="text-gray-400">info@galaxyenterprise.com</span>
              </li>
            </ul>
          </div>
